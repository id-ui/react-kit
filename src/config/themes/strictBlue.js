export default {
    colors: {
        ...
        primary: '#1016E0', // for elements background or color
        primaryHighlight: '#0106B8', // for highlighting elements with primary color during interactions
        primaryContrast: '#FFFFFF',

        secondary: '#0DF2C9', // accent color for elements background or color
        secondaryHighlight: '#00DBB3', // for highlighting elements with secondary color during interactions
