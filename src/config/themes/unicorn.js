export default {
    colors: {
        ...
        primary: '#FA31A8', // for elements background or color
        primaryHighlight: '#E41690', // for highlighting elements with primary color during interactions
        primaryContrast: '#FFFFFF',

        secondary: '#6A50EF', // accent color for elements background or color
        secondaryHighlight: '#573FD3', // for highlighting elements with secondary color during interactions
